...
const styles = StyleSheet.create({
    customLeft: { position: 'absolute', left: 0, marginVertical: 15, paddingHorizontal: 10 },
    customRight: { position: 'absolute', right: 0, marginVertical: 15, paddingHorizontal: 10 }
});
